<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="mswanson2h1._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <asp:Label ID="Label5" runat="server" Text="5) DateTime.AddMonths(30):"></asp:Label>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6aInput" runat="server" Width="40px">2020</asp:TextBox>
                <asp:TextBox ID="TextBox6bInput" runat="server" Width="30px">11</asp:TextBox>
                <asp:TextBox ID="TextBox6cInput" runat="server" Width="30px">01</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox7Input" runat="server">November 1, 2020</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox8Input" runat="server">November 1, 2020</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9aInput" runat="server" Width="80px">1/13/2014</asp:TextBox>
                <asp:TextBox ID="TextBox9bInput" runat="server" Width="80px">12/12/2013</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox10aInput" runat="server" Width="80px">1/13/2014</asp:TextBox>
                <asp:TextBox ID="TextBox10bInput" runat="server" Width="80px">12/12/2013</asp:TextBox>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox15" runat="server">(652) 385-6300</asp:TextBox>
            ...
            <div class="form-group">
                <asp:Label ID="Label18" runat="server" Text="IndexOf/Substring: "></asp:Label>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox19" runat="server" Width="204px">111 1st St, Lake City, MN 55041</asp:TextBox>
